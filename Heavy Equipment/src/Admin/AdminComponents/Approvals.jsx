        ...
        <Modal.Body style={styles.modalBody}>
          {selectedTransaction && selectedItem && (
            <div>
              ...
              <p><strong>Description:</strong> Compact excavators for tight spaces.</p>
              <p><strong>Stock Quantity:</strong> 15</p>
              <p><strong>Rental Price:</strong> $1000</p>
              <p><strong>Buy Price:</strong> $50000</p>
              <p><strong>Brand:</strong> {selectedItem.brand}</p>
              <p><strong>Model:</strong> {selectedItem.model}</p>
              <p><strong>Manufacturing Year:</strong> {selectedItem.manufacturingYear}</p>
              <p><strong>Usages:</strong> {selectedItem.usages}</p>
              <p><strong>Origin:</strong> {selectedItem.origin}</p>
              <p><strong>Is Available:</strong> Yes</p>
