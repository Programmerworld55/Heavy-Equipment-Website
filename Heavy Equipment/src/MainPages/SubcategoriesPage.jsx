...
const SubcategoriesPage = () => {
  ...
  // const { setCategoryData } = useContext(CategoryContext);

  const handleSubcategoryClick = (subcategory) => {
    console.log("Subcategory clicked:", subcategory);
    // setCategoryData({ subcategory, subcategoryId: subcategory.id });
    console.log("Category data set:", { subcategory, subcategoryId: subcategory.id });
  ...
  const handleButtonClick = (subcategory, action) => {
    ...
    if (user) {
      // setCategoryData({ userDetails: JSON.parse(user), subcategory, subcategoryId: subcategory.id, action });
      console.log("Category data set with user details:", { userDetails: JSON.parse(user), subcategory, subcategoryId: subcategory.id, action });
            ...
            <div key={index} className="col-md-6 col-lg-4 mb-4">
              <div
                ...
                style={{
                  ...
                  minHeight: "600px", // Further increase card height
